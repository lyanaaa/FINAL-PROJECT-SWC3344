...
public class MainCitizen 
{
    ...
    try {
            ...
            LinkedList <Citizen2> templist = new LinkedList<>();
            ...
            c1 = new Citizen2(name, ic, state, age, Category, firstdose);
        ...
        Queue<Citizen2> tempQ1 = new LinkedList<>();
        Queue<Citizen2> tempQ2 = new LinkedList<>();
        Queue<Citizen2> tempQ3 = new LinkedList<>();
        ...
        do {
            ...
            if(menu == 1) //add the new recipient
            {
                ...
                while(!templist.isEmpty()) {
                    c1 = templist.removeLast();
                    if (c1.getAge() >= 18 && c1.getAge()<=30){
                    	c1.setFirstdose("Completed");
                        tempQ1.add(c1); 
                    }
                    
                    if (c1.getAge() >= 31 && c1.getAge()<=49) {
                    	c1.setFirstdose("Completed");
                    tempQ2.add(c1); 
                    }
                    if (c1.getAge() >= 50) {
                ...
                System.out.println(qCenter1);
                System.out.println(qCenter2);
                System.out.println(qCenter3);
                System.out.println(stCenter1);
                System.out.println(stCenter2);
                System.out.println(stCenter3);
            ...
            else if(menu == 5)
            {
                ...
                do
                {
                    ...
                    if(submenu == 1)
                    {
                        ...
                        System.out.println(tempQ1.toString());
                        String.format("| %15s | %15s | %15s | %15s | %15s | %15s |\n ", "name", "ic", "state", "age", "category", "firstdose");
                        System.out.println(tempQ2.toString());
                        String.format("| %15s | %15s | %15s | %15s | %15s | %15s |\n ", "name", "ic", "state", "age", "category", "firstdose");
                        
                        System.out.println(tempQ3.toString());
